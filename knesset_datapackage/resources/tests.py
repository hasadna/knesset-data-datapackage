...
class ResourcesTestCase(BaseDatapackageTestCase):
    ...
    def test_committee_meetings(self):
        ...
        fetched_items = [dict(oredered_dict.items()) for oredered_dict in fetched_items]
        get_meeting = lambda id: dict({"id": id,
                                       'session_content': u'',
                                       'agenda_special ': u'',
                                       'datetime': datetime.datetime(2013, 5, id, 16, 33),
                                       'material_expiration_date ': u'',
                                       'meeting_stop ': u'',
                                       'agenda_associated_id ': u'',
                                       'committee_id': None,
                                       'agenda_invite ': u'',
                                       'title': u'',
                                       'creation_date ': u'',
                                       ...
                                       'note ': u'', 'day ': u'',
                                       'material_id ': u'',
                                       'start_datetime ': u'2013-05-0{}T16:44:00'.format(id),
                                       'material_hour ': u'',
                                       'is_paused ': u'',
                                       'agenda_associated ': u'',
                                       'date_order ': u'',
                                       ...
                                       'agenda_invited ': u'',
                                       'agenda_canceled ': u'',
                                       'material_committee_id ': u'',
                                       'background_page_link ': u'',
                                       "url": u"mock url {}".format(id)})
        self.assertEqual(fetched_items, [get_meeting(1),get_meeting(2),get_meeting(3)])
